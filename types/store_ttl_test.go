...
func TestStoreGetDirectory(t *testing.T) {
	...
	fc := newFakeClock()
	s.clock = fc
	s.Create("/foo", true, "", false, TTLOptionSet{ExpireTime: v2store.Permanent})
	s.Create("/foo/bar", false, "X", false, TTLOptionSet{ExpireTime: v2store.Permanent})
	s.Create("/foo/_hidden", false, "*", false, TTLOptionSet{ExpireTime: v2store.Permanent})
	s.Create("/foo/baz", true, "", false, TTLOptionSet{ExpireTime: v2store.Permanent})
	s.Create("/foo/baz/bat", false, "Y", false, TTLOptionSet{ExpireTime: v2store.Permanent})
	s.Create("/foo/baz/_hidden", false, "*", false, TTLOptionSet{ExpireTime: v2store.Permanent})
	...
	var bazNodes v2store.NodeExterns
...
func TestStoreUpdateValueTTL(t *testing.T) {
	...
	var eidx uint64 = 2
	s.Create("/foo", false, "bar", false, TTLOptionSet{ExpireTime: v2store.Permanent})
...
func TestStoreUpdateDirTTL(t *testing.T) {
	...
	var eidx uint64 = 3
	_, err := s.Create("/foo", true, "", false, TTLOptionSet{ExpireTime: v2store.Permanent})
	testutil.AssertNil(t, err)
	_, err = s.Create("/foo/bar", false, "baz", false, TTLOptionSet{ExpireTime: v2store.Permanent})
	testutil.AssertNil(t, err)
...
func TestStoreRecoverWithExpiration(t *testing.T) {
	...
	var eidx uint64 = 4
	s.Create("/foo", true, "", false, TTLOptionSet{ExpireTime: v2store.Permanent})
	s.Create("/foo/x", false, "bar", false, TTLOptionSet{ExpireTime: v2store.Permanent})
