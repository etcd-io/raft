...
function trace-validation_pass {
  ...
  GOLANG_TEST_SHORT=true WORKING_DIR=${WORKING_DIR} go test -short -timeout="${TIMEOUT:-30m}" -tags with_tla -run ^TestTraceValidationWithRandomFaults$ go.etcd.io/raft/v3/rafttest
}
