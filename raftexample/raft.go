...
import (
	...
	"go.etcd.io/raft/v3"
	"go.etcd.io/raft/v3/fileutil"
	"go.etcd.io/raft/v3/rafthttp"
	"go.etcd.io/raft/v3/raftpb"
	"go.etcd.io/raft/v3/snap"
	"go.etcd.io/raft/v3/types"
	"go.etcd.io/raft/v3/v2stats"
	"go.etcd.io/raft/v3/wal"
	"go.etcd.io/raft/v3/wal/walpb"
...
func (rc *raftNode) startRaft() {
	...
	rc.transport = &rafthttp.Transport{
		...
		LeaderStats: v2stats.NewLeaderStats(zap.NewExample(), strconv.Itoa(rc.id)),
		ErrorC:      make(chan error),
	}
