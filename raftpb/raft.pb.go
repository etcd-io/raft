...
type Message struct {
	...
	// applied_snapshot_index is used for MsgSnapStatus to report back the applied snapshot index.
	AppliedSnapshotIndex uint64 `protobuf:"varint,15,opt,name=applied_snapshot_index,json=appliedSnapshotIndex" json:"applied_snapshot_index"`
}
...
var fileDescriptor_b042552c306ae59b = []byte{
	...
	,
}
...
func (m *Message) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	i = encodeVarintRaft(dAtA, i, uint64(m.AppliedSnapshotIndex))
	i--
	dAtA[i] = 0x78
...
func (m *Message) Size() (n int) {
	...
	n += 1 + sovRaft(uint64(m.AppliedSnapshotIndex))
	return n
}
...
func (m *Message) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 15:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AppliedSnapshotIndex", wireType)
			}
			m.AppliedSnapshotIndex = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowRaft
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.AppliedSnapshotIndex |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
